...
ScoreConeTop::ScoreConeTop(Elevator* m_elevator)
...
void ScoreConeTop::End(bool interrupted) 
{
    m_targetReached = false;
}

bool ScoreConeTop::RunsWhenDisabled() const {
